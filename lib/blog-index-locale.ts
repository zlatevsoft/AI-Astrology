...
export const blogIndexCopy = {
  en: {
    ...
    h2: 'Astrology Insights & Birth Chart Analysis',
    intro:
      'Discover expert astro horoscope articles and professional birth-chart analysis tips. Learn how cosmic rhythms shape themes in your chart on AstroHoroscope.online.',
    featured: 'Featured Article',
    cardHint: 'Astro Horoscope',
    readFull: 'Read Full Article',
    readMore: 'Read More',
    ctaTitle: 'Get Your Personal Astro Horoscope Birth Chart',
  ...
  bg: {
    ...
    h2: 'Хороскоп и натална карта',
    intro:
      'Статии за астрологичен хороскоп и натална карта. Как небесните акценти оформят темите ти на AstroHoroscope.online.',
    featured: 'Избрана статия',
    cardHint: 'Astro Horoscope',
    readFull: 'Прочети цялата статия',
    readMore: 'Още',
    ctaTitle: 'Персонална натална карта',
...
const raw: Array<{
...
}> = [
  {
    ...
    featured: true,
    en: {
      title: 'Understanding Your Birth Chart: Complete Astro Guide',
      excerpt:
        'Learn how to interpret your birth chart. Discover what your horoscope reveals about your personality and life path.',
      category: 'Birth Chart Analysis',
      read: '8 min read',
    },
    bg: {
      title: 'Наталната ти карта: пълен практически пътеводител',
      excerpt:
        'Как да четеш картата си професионално. Какви черти и път разкрива хороскопът ти.',
  ...
  },
  {
    ...
    featured: false,
    en: {
      title: 'Zodiac Signs Personality Traits: Deep Dive',
      excerpt: 'Personality patterns of each zodiac sign explored through professional astrology.',
      category: 'Zodiac Analysis',
      read: '6 min read',
    },
    bg: {
      title: 'Зодиакални типове: поглед върху личността',
      excerpt: 'Характерни черти на зодиакалните знаци в професионално четене.',
      category: 'Зодии',
      read: '6 мин четене',
    },
  },
  {
    ...
    featured: false,
    en: {
      title: 'Love Compatibility: Zodiac Signs Guide',
      excerpt: 'Explore love compatibility through chart themes. Find your cosmic match.',
      category: 'Love & Relationships',
      read: '7 min read',
    },
    bg: {
      title: 'Любов и съвместимост между зодии',
      excerpt: 'Как зодиакалните комбинации влияят на връзката – обяснено структурирано.',
      category: 'Любов',
      read: '7 мин четене',
    },
  },
  {
    ...
    en: {
      ...
      excerpt: 'Career paths that fit your zodiac sign and chart emphasis.',
      category: 'Career Guidance',
      read: '6 min read',
    },
    bg: {
      title: 'Кариера и зодия: кои посоки подхождат',
      excerpt: 'Професионални тенденции по зодия и акценти в картата.',
      category: 'Кариера',
      read: '6 мин четене',
    },
  },
  {
    ...
    featured: false,
    en: {
      title: 'Daily Horoscope: Personalized Predictions',
      excerpt: 'Personalized daily guidance rooted in your chart context at AstroHoroscope.online.',
      category: 'Daily Predictions',
      read: '5 min read',
    },
    bg: {
      title: 'Дневен хороскоп: персонален фокус',
      excerpt: 'Кратки прогнози и акценти за деня според картата ти.',
  ...
  },
  {
    ...
    en: {
      ...
      excerpt: 'How transits affect your life—and how to track them practically.',
      category: 'Planetary Analysis',
      read: '7 min read',
    },
    bg: {
      title: 'Планетарни транзити: космически влияния',
      excerpt: 'Промени в небето и отражение върху теб – структуриран обзор.',
      category: 'Планети',
      read: '7 мин четене',
    },
  },
  ...
  },
  {
    ...
    bg: {
      ...
      excerpt: 'Четирите елемента – темперамент и стил в наталната карта.',
      category: 'Елементи',
      read: '5 мин четене',
    },
  },
  {
    ...
    bg: {
      ...
      excerpt: 'Трите мода – как започваме, крепим и се променяме (накратко в картата).',
      category: 'Модалности',
      read: '5 мин четене',
    },
  },
