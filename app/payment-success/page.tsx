    ...
    try {
      ...
      pdfContainer.innerHTML = `
        ...
        <div style="margin-top: 40px; padding-top: 20px; border-top: 2px solid #6366f1; text-align: center; color: #6b7280;">
          <p style="margin: 0;">Generated by AI Astrology</p>
          <p style="margin: 5px 0;">Visit: https://ai-astrology.com</p>
        </div>
      `
      ...
      // Download PDF
      pdf.save(`ai-astrology-analysis-${analysisData.analysisType}-${Date.now()}.pdf`)
