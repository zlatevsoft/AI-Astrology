...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt:
      'Discover the unique personality traits of each zodiac sign through AI astrology analysis. Understand your cosmic character at AstroHoroscope.online.',
  ...
  },
  {
    ...
    excerpt:
      'Explore love compatibility between zodiac signs with AI astrology. Find your perfect cosmic match at AstroHoroscope.online.',
  ...
  },
  {
    ...
    excerpt:
      'Discover the best career paths for your zodiac sign with AI astrology. Find your cosmic calling at AstroHoroscope.online.',
  ...
  },
  {
    ...
    excerpt:
      'Get personalized daily horoscope predictions with AI astrology. Discover your cosmic guidance at AstroHoroscope.online.',
  ...
  },
  {
    ...
    excerpt:
      'Understand planetary transits and their influence on your life with AI astrology. Navigate cosmic changes at AstroHoroscope.online.',
  ...
  },
  {
    ...
    excerpt:
      'Learn about astrological aspects and their influence on your personality with AI astrology. Understand cosmic relationships at AstroHoroscope.online.',
  ...
  },
  {
    ...
    excerpt:
      'Explore astrological houses and their influence on different life areas with AI astrology. Understand your cosmic life map at AstroHoroscope.online.',
  ...
  },
  {
    ...
    excerpt:
      'Learn about astrological elements with AI astrology. Understand Fire, Earth, Air & Water in your astro horoscope at AstroHoroscope.online.',
  ...
  },
  {
    ...
    excerpt:
      'Learn about astrological modalities with AI astrology. Understand Cardinal, Fixed & Mutable signs in your astro horoscope at AstroHoroscope.online.',
  ...
  },
  {
    ...
    excerpt:
      'Learn about retrograde planets with AI astrology. Understand Mercury, Venus, Mars retrogrades in your astro horoscope at AstroHoroscope.online.',
    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-cosmic-50 via-white to-purple-50 dark:from-cosmic-950 dark:via-cosmic-900 dark:to-purple-950">
        <div className="container mx-auto px-4 py-16">
          {/* Header (секцията за блога, не глобалният компонент) */}
          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-to-r from-cosmic-500 to-purple-600 rounded-2xl p-8 text-white">
              <h3 className="text-2xl md:text-3xl font-bold mb-4">Get Your Personal AI Astrology Birth Chart</h3>
