...
export default function AstrologicalHousesPage() {
  return (
            ...
            <section className="text-center">
              <div className="bg-gradient-to-r from-cosmic-500 to-purple-600 rounded-2xl p-8 text-white">
                <h3 className="text-2xl md:text-3xl font-bold mb-4">
                  Explore Your Astrological Houses
                </h3>
                <p className="text-lg mb-6 opacity-90">
                  Get detailed house analysis at AstroHoroscope.online. Understand how cosmic energies manifest in your life areas.
                </p>
