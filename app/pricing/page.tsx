    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-cosmic-50 via-white to-purple-50 dark:from-cosmic-950 dark:via-cosmic-900 dark:to-purple-950 pt-20">
        <div className="container mx-auto px-4 py-12">
          ...
          >
            <h2 className="text-3xl font-bold text-cosmic-800 dark:text-cosmic-200 mb-8">
              Frequently Asked Questions
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="text-left">
                <h3 className="font-semibold text-cosmic-800 dark:text-cosmic-200 mb-2">
                  How accurate are the AI readings?
                </h3>
                <p className="text-cosmic-600 dark:text-cosmic-400 text-sm">
                  Our AI is trained on extensive astrological knowledge and provides highly accurate, personalized interpretations based on your exact birth data.
                </p>
              </div>
              ...
              <div className="text-left">
                ...
                <p className="text-cosmic-600 dark:text-cosmic-400 text-sm">
                  Your personalized analysis is generated instantly using our advanced AI technology. No waiting required!
                </p>
              </div>
            </div>
          </motion.div>
